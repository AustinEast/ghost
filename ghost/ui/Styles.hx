...
class Styles {
  ...
  public static function apply_flow_styles(flow:Flow, ?styles:FlowStyle):Flow {
    var nstyles:FlowStyle = JSON.copy_fields(Styles.flow, Styles.flow_defaults);
    styles = JSON.copy_fields(styles, nstyles);
  ...
  public static function apply_text_styles(text:Text, ?styles:TextStyle):Text {
    var nstyles:TextStyle = JSON.copy_fields(Styles.text, Styles.text_defaults);
    styles = JSON.copy_fields(styles, nstyles);
