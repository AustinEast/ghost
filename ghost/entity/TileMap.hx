...
class TileMap extends Entity {
  ...
  public function generate_collider(collision:TileCollision = OPTIMIZED, start_index:Int = 0, ?ignore:Array<Int>, ?top_left_slopes:Array<Int>,
      ?top_right_slopes:Array<Int>, ?bottom_left_slopes:Array<Int>, ?bottom_right_slopes:Array<Int>) {
    if (colliders != null) {
