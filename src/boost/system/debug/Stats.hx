...
class Stats extends Object {
    ...
    public function new(?parent:Object) {
        ...
        fps.dropShadow = {dx : 1, dy : 1, color : Color.BLACK, alpha : 1};
        width = new Text(font, this);
        width.y = fps.y + font.lineHeight + padding;
        width.dropShadow = {dx : 1, dy : 1, color : Color.BLACK, alpha : 1};
        height = new Text(font, this);
        height.y = width.y + font.lineHeight + padding;
        height.dropShadow = {dx : 1, dy : 1, color : Color.BLACK, alpha : 1};
    }
