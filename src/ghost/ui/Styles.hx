...
class Styles {
  ...
  public static function apply_flow_styles(flow:Flow, ?styles:FlowStyle):Flow {
    var nstyles:FlowStyle = DataUtil.copy_fields(Styles.flow, Styles.flow_defaults);
    styles = DataUtil.copy_fields(styles, nstyles);
  ...
  public static function apply_text_styles(text:Text, ?styles:TextStyle):Text {
    var nstyles:TextStyle = DataUtil.copy_fields(Styles.text, Styles.text_defaults);
    styles = DataUtil.copy_fields(styles, nstyles);
