...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Ghost Samples", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Ghost Samples", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Ghost Samples";
		app.meta["name"] = "Ghost Samples";
